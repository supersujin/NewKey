...
public class CatLifeFragment extends Fragment {
    ArrayList<NewsData> newsList;
    RequestQueue queue;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView=(ViewGroup) inflater.inflate(R.layout.fragment_cat_life, container, false);

        newsList=new ArrayList<>();
        queue= Volley.newRequestQueue(rootView.getContext());
        String url = "http://44.212.55.152:5000/life";
